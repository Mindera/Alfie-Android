...
fun ButtonType.colorSpec(): ButtonColorSpec {
    ...
    return when (this) {
        ButtonType.Primary -> ButtonColorSpec(
            background = c.neutrals800, text = c.neutrals0, icon = c.neutrals0, border = c.neutrals800,
            disabledBackground = c.neutrals300, disabledText = c.neutrals500, disabledIcon = c.neutrals500, disabledBorder = c.neutrals300,
        )
        ButtonType.Secondary -> ButtonColorSpec(
            background = c.transparent, text = c.neutrals800, icon = c.neutrals900, border = c.neutrals900,
            disabledBackground = c.transparent, disabledText = c.neutrals500, disabledIcon = c.neutrals500, disabledBorder = c.neutrals500,
        )
        ButtonType.Tertiary -> ButtonColorSpec(
            background = c.transparent, text = c.neutrals800, icon = c.neutrals900, border = c.transparent,
            disabledBackground = c.transparent, disabledText = c.neutrals400, disabledIcon = c.neutrals500, disabledBorder = c.transparent,
        )
        ButtonType.Destructive -> ButtonColorSpec(
            background = c.semanticError600, text = c.neutrals0, icon = c.neutrals0, border = c.semanticError600,
            disabledBackground = c.neutrals300, disabledText = c.neutrals500, disabledIcon = c.neutrals500, disabledBorder = c.neutrals300,
        )
        ButtonType.Underlined -> ButtonColorSpec(
            background = c.transparent, text = c.neutrals800, icon = c.neutrals800, border = c.transparent,
            disabledBackground = c.transparent, disabledText = c.neutrals400, disabledIcon = c.neutrals400, disabledBorder = c.transparent,
        )
    }
}
