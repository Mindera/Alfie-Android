package com.mindera.alfie.core.sync.worker
...
import com.mindera.alfie.core.sync.di.HiltWorkerFactoryEntryPoint
import com.mindera.alfie.core.sync.worker.DelegatingWorker.Companion.WORKER_CLASS_NAME
